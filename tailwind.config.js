  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        "body-secondary-desktop": ['var(--body-secondary-desktop)', 'var(--body-secondary-desktop-leading)'],
        "body-secondary-bold-mobile": ['var(--body-secondary-mobile)', {
          lineHeight: 'var(--body-secondary-mobile-leading)',
          fontWeight: 700,
        }],
        "body-secondary-bold-desktop": ['var(--body-secondary-desktop)', {
          lineHeight: 'var(--body-secondary-desktop-leading)',
          fontWeight: 700,
        }],
        "body-large": ['var(--body-large)', 'var(--body-large-leading)'],
        "body-large-bold": ['var(--body-large)', {
          lineHeight: 'var(--body-large-leading)',
          fontWeight: 700,
        }],
        "body-medium": ['var(--body-medium)', 'var(--body-medium-leading)'],
        "body-medium-bold": ['var(--body-medium)', {
          lineHeight: 'var(--body-medium-leading)',
          fontWeight: 700,
        }],
        "body-small": ['var(--body-small)', 'var(--body-small-leading)'],
        "body-small-bold": ['var(--body-small)', {
          lineHeight: 'var(--body-small-leading)',
          fontWeight: 700,
        }],
        "interface-heading-one-desktop": ['var(--interface-heading-one-desktop)', {
          lineHeight: 'var(--interface-heading-one-desktop-leading)',
          fontWeight: 700,
        }],
        "interface-heading-one-mobile": ['var(--interface-heading-one-mobile)', {
          lineHeight: 'var(--interface-heading-one-mobile)',
          fontWeight: 700,
        }],
        "interface-primary": ['var(--interface-primary)', 'var(--interface-primary-leading)'],
        "interface-secondary": ['var(--interface-secondary)', 'var(--interface-secondary-leading)'],
        "interface-caption": ['var(--interface-caption)', 'var(--interface-caption-leading)'],
        "interface-error-mobile": ['var(--interface-error-mobile)', 'var(--interface-error-mobile-leading)'],
        "interface-error-desktop": ['var(--interface-error-desktop)', 'var(--interface-error-desktop-leading)'],
      },
      backgroundImage: {
